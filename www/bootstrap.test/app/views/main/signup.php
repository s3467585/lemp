			...
			<div class="modal-body p-5 pt-0">
				<form form action="/signup" method="POST" class="">
					<div class="form-floating mb-3">
						<input type="text" class="form-control rounded-3" placeholder="Введите своё полное имя" name="full_name" id="full_name" autocomplete="full_name">
						<label for="email">Ф.И.О</label>
					</div>
					<div class="form-floating mb-3">
						<input type="text" class="form-control rounded-3" placeholder="Введите своё полное имя" name="login" id="login" autocomplete="login">
						<label for="email">Логин</label>
					</div>
					<div class="form-floating mb-3">
						<input type="email" class="form-control rounded-3" placeholder="Введите адрес своей почты" name="email" id="email" autocomplete="email">
					...
					<div class="form-floating mb-3">
						<input type="password" class="form-control rounded-3" placeholder="Подтвердите пароль" name="password_confirm" id="password_confirm" autocomplete="off">
