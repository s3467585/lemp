...
curl -X POST http://bootstrap.test/api/json -H 'Content-Type: application/json' -d '{"login":"my_login","password":"my_password"}'
curl -X POST http://bootstrap.test/api/json -H 'Content-Type: application/json' -d '{"login":{"this":{"string":"[BME280_1#temp]","be":"JSON","data":{"one":1,"two":2,"bool":3}}}}'
